...
public class DataSource {
...

    {
        ...
        Book book5 = new Book("Горе от ума", "Александр Сергеевич Грибоедов", "Главным замыслом произведения является иллюстрация подлости, " +
                "невежества и раболепия перед чинами и традициями, противостояли которым новые идеи, подлинная культура, свобода и разум.");
        Book book6 = new Book("Евгений Онегин", "Александр Сергеевич Пушкин", "Это одно из самых гармоничных по композиции и богатых по содержанию произведений Пушкина. " +
                "Благодаря выражению эмоций героев посредством стихотворной формы, роман получает большую лиричность и выразительность, " +
                "таким образом, читателю становится понятна и доступна вся палитра чувств, которую закладывал в основу автор.");
        Book book7 = new Book("Герой нашего времени", "Михаил Юрьевич Лермонтов", "");
        Book book8 = new Book("Мёртвые души", "Николай Васильевич Гоголь", "");
        Book book9 = new Book("Горе от ума", "Александр Сергеевич Грибоедов", "Главным замыслом произведения является иллюстрация подлости, " +
                "невежества и раболепия перед чинами и традициями, противостояли которым новые идеи, подлинная культура, свобода и разум.");
        Book book10 = new Book("Евгений Онегин", "Александр Сергеевич Пушкин", "Это одно из самых гармоничных по композиции и богатых по содержанию произведений Пушкина. " +
                "Благодаря выражению эмоций героев посредством стихотворной формы, роман получает большую лиричность и выразительность, " +
                "таким образом, читателю становится понятна и доступна вся палитра чувств, которую закладывал в основу автор.");
        Book book11 = new Book("Герой нашего времени", "Михаил Юрьевич Лермонтов", "");
        Book book12 = new Book("Мёртвые души", "Николай Васильевич Гоголь", "");
        bookList = Arrays.asList(book1, book2, book3, book4, book5, book6, book7, book8, book9, book10, book11, book12);
    }
